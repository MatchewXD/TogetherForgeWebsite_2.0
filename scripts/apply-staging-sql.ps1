...
$ordered = @(
  ...
  "supabase/sql/supabase_activity_log_drop_progress.sql",
  ...
  "supabase/sql/supabase_kofi_runway.sql",
  "supabase/sql/supabase_kofi_runway_stack.sql",
  ...
  "supabase/sql/supabase_staff_credit.sql",
  "supabase/sql/supabase_conduct.sql",
  ...
  "supabase/sql/supabase_payments_policy_acceptance.sql",
  "supabase/sql/supabase_ai_tokens.sql",
  "supabase/sql/supabase_ai_token_ledger_security_invoker.sql",
