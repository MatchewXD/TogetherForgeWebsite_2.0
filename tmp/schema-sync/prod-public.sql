...
CREATE OR REPLACE FUNCTION "public"."get_public_recent_donations"("limit_n" integer DEFAULT 12) RETURNS json
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select coalesce(
...
ALTER FUNCTION "public"."get_public_recent_donations"("limit_n" integer) OWNER TO "postgres";


COMMENT ON FUNCTION "public"."get_public_recent_donations"("limit_n" integer) IS 'Last N studio payments for Recent support: time + optional username/avatar (no amounts shown in UI).';
...
COMMENT ON FUNCTION "public"."get_public_support_summary"() IS 'Anonymized studio + runway support totals for Transparency Hub.';
...
CREATE TABLE IF NOT EXISTS "public"."ideas" (
    ...
    "economy_resource" "text",
    "economy_trading" "text",
    "has_main_story" boolean DEFAULT false,
    "has_endgame" boolean DEFAULT false,
    "endgame_details" "text",
    "project_id" "text",
...
COMMENT ON COLUMN "public"."ideas"."status" IS 'Workflow: Proposed | UnderReview | Adopted | Archived';



COMMENT ON COLUMN "public"."ideas"."guided_data" IS 'JSON from Guided Idea Creation wizard (step 2 structured fields)';
...
begin
  ...
  if v_claim.user_id <> v_uid and not public.is_project_staff() then
...
begin
  ...
  select exists (
    ...
    from auth.identities i
    where i.user_id = p_user_id
      and lower(i.provider) in ('discord', 'google')
  ) into v_sso_ok;
...
CREATE TABLE IF NOT EXISTS "public"."phase_games" (
    "id" "text" NOT NULL,
    "title" "text" NOT NULL,
    "description" "text",
    "status" "text",
...
ALTER TABLE "public"."phase_games" OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."projects"."release_meta" IS 'Optional Released Games detail fields: tagline, platforms, genre, media[], ratings[], development_story, cover_image, origin_idea_ids';
...
ALTER TABLE ONLY "public"."phase_games"
    ADD CONSTRAINT "phase_games_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."votes"
    ADD CONSTRAINT "votes_idea_user_unique" UNIQUE ("idea_id", "user_id");
...
CREATE OR REPLACE TRIGGER "trg_sync_badges_on_claim" AFTER INSERT OR UPDATE OF "status" ON "public"."task_claims" FOR EACH ROW EXECUTE FUNCTION "public"."trg_sync_badges_on_claim"();
...
CREATE POLICY "Anyone can read phase_games" ON "public"."phase_games" FOR SELECT TO "authenticated", "anon" USING (true);
...
CREATE POLICY "Anyone can submit bug reports" ON "public"."bug_reports" FOR INSERT WITH CHECK (((("reporter_id" IS NULL) OR ("reporter_id" = "auth"."uid"())) AND ("length"(TRIM(BOTH FROM "title")) >= 3) AND ("length"(TRIM(BOTH FROM "description")) >= 10)));



CREATE POLICY "Anyone can submit showcase posts" ON "public"."community_showcase_posts" FOR INSERT WITH CHECK ((("status" = 'pending'::"text") AND ("is_featured" = false) AND ("moderated_by" IS NULL) AND ("moderated_at" IS NULL)));
...
CREATE POLICY "Moderators can manage official projects" ON "public"."phase_games" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = ANY (ARRAY['moderator'::"text", 'admin'::"text"])))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = ANY (ARRAY['moderator'::"text", 'admin'::"text"]))))));



CREATE POLICY "Moderators can manage page content" ON "public"."page_content" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = ANY (ARRAY['moderator'::"text", 'admin'::"text"])))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = ANY (ARRAY['moderator'::"text", 'admin'::"text"]))))));
...
CREATE POLICY "Owners can update their ideas" ON "public"."ideas" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "Users can read their own votes" ON "public"."votes" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
ALTER TABLE "public"."phase_games" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."idea_tags" TO "anon";
GRANT ALL ON TABLE "public"."idea_tags" TO "authenticated";
GRANT ALL ON TABLE "public"."idea_tags" TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_approve_idea_tag"("p_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."admin_approve_idea_tag"("p_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_approve_idea_tag"("p_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_delete_idea_tag"("p_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."admin_delete_idea_tag"("p_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_delete_idea_tag"("p_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_hide_idea_tag"("p_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."admin_hide_idea_tag"("p_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_hide_idea_tag"("p_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_merge_idea_tags"("p_source_id" "uuid", "p_target_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."admin_merge_idea_tags"("p_source_id" "uuid", "p_target_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_merge_idea_tags"("p_source_id" "uuid", "p_target_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_rename_idea_tag"("p_id" "uuid", "p_new_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."admin_rename_idea_tag"("p_id" "uuid", "p_new_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_rename_idea_tag"("p_id" "uuid", "p_new_name" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_unhide_idea_tag"("p_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."admin_unhide_idea_tag"("p_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_unhide_idea_tag"("p_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."ai_token_ledger_immutable"() TO "anon";
GRANT ALL ON FUNCTION "public"."ai_token_ledger_immutable"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."ai_token_ledger_immutable"() TO "service_role";



GRANT ALL ON FUNCTION "public"."apply_claim_restriction"("p_user_id" "uuid", "p_actor_id" "uuid", "p_reason" "text", "p_task_id" "uuid", "p_claim_id" "uuid", "p_increment_fake" boolean) TO "anon";
...
GRANT ALL ON FUNCTION "public"."apply_claim_restriction"("p_user_id" "uuid", "p_actor_id" "uuid", "p_reason" "text", "p_task_id" "uuid", "p_claim_id" "uuid", "p_increment_fake" boolean) TO "service_role";



GRANT ALL ON FUNCTION "public"."assert_action_allowed"("p_action" "text", "p_limit" integer, "p_window" interval, "p_min_gap" interval, "p_actor_key" "text") TO "anon";
...
GRANT ALL ON FUNCTION "public"."assert_action_allowed"("p_action" "text", "p_limit" integer, "p_window" interval, "p_min_gap" interval, "p_actor_key" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."backfill_all_user_badges"() TO "anon";
GRANT ALL ON FUNCTION "public"."backfill_all_user_badges"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."backfill_all_user_badges"() TO "service_role";



GRANT ALL ON FUNCTION "public"."badge_donation_thresholds_cents"() TO "anon";
GRANT ALL ON FUNCTION "public"."badge_donation_thresholds_cents"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."badge_donation_thresholds_cents"() TO "service_role";



GRANT ALL ON FUNCTION "public"."badge_task_thresholds"() TO "anon";
GRANT ALL ON FUNCTION "public"."badge_task_thresholds"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."badge_task_thresholds"() TO "service_role";



GRANT ALL ON FUNCTION "public"."bump_idea_tag_usage"("p_names" "text"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."bump_idea_tag_usage"("p_names" "text"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."bump_idea_tag_usage"("p_names" "text"[]) TO "service_role";



GRANT ALL ON FUNCTION "public"."cancel_task_scope_request"("p_request_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."cancel_task_scope_request"("p_request_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."cancel_task_scope_request"("p_request_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."claim_task"("p_task_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."claim_task"("p_task_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."claim_task"("p_task_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."complete_task"("p_task_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."complete_task"("p_task_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."complete_task"("p_task_id" "uuid") TO "service_role";



GRANT ALL ON TABLE "public"."ai_token_ledger" TO "anon";
GRANT ALL ON TABLE "public"."ai_token_ledger" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_token_ledger" TO "service_role";
...
GRANT ALL ON FUNCTION "public"."credit_ai_tokens"("p_user_id" "uuid", "p_tokens" integer, "p_entry_type" "text", "p_status" "text", "p_prompt_summary" "text", "p_pack_id" "text", "p_purchase_id" "uuid", "p_source" "text", "p_source_ref" "text", "p_stripe_session_id" "text", "p_stripe_payment_intent" "text", "p_idempotency_key" "text", "p_meta" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."credit_ai_tokens"("p_user_id" "uuid", "p_tokens" integer, "p_entry_type" "text", "p_status" "text", "p_prompt_summary" "text", "p_pack_id" "text", "p_purchase_id" "uuid", "p_source" "text", "p_source_ref" "text", "p_stripe_session_id" "text", "p_stripe_payment_intent" "text", "p_idempotency_key" "text", "p_meta" "jsonb") TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."enforce_concern_report_rate"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_concern_report_rate"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_concern_report_rate"() TO "service_role";



GRANT ALL ON FUNCTION "public"."enforce_idea_comment_rules"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_idea_comment_rules"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_idea_comment_rules"() TO "service_role";



GRANT ALL ON FUNCTION "public"."enforce_idea_submit_rules"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_idea_submit_rules"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_idea_submit_rules"() TO "service_role";



GRANT ALL ON FUNCTION "public"."enforce_idea_vote_rate"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_idea_vote_rate"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_idea_vote_rate"() TO "service_role";



GRANT ALL ON FUNCTION "public"."enforce_showcase_like_rate"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_showcase_like_rate"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_showcase_like_rate"() TO "service_role";



GRANT ALL ON FUNCTION "public"."enforce_showcase_submit_rules"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_showcase_submit_rules"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_showcase_submit_rules"() TO "service_role";



GRANT ALL ON FUNCTION "public"."enforce_task_claim_rate"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_task_claim_rate"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_task_claim_rate"() TO "service_role";



GRANT ALL ON FUNCTION "public"."enforce_task_parent"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_task_parent"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_task_parent"() TO "service_role";



GRANT ALL ON FUNCTION "public"."enforce_volunteer_app_rate"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_volunteer_app_rate"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_volunteer_app_rate"() TO "service_role";



GRANT ALL ON TABLE "public"."ai_token_balances" TO "anon";
GRANT ALL ON TABLE "public"."ai_token_balances" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_token_balances" TO "service_role";



REVOKE ALL ON FUNCTION "public"."ensure_ai_token_balance"("p_user_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."ensure_ai_token_balance"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."ensure_ai_token_balance"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."ensure_ai_token_balance"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."ensure_idea_tag"("p_name" "text", "p_as_curated" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."ensure_idea_tag"("p_name" "text", "p_as_curated" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."ensure_idea_tag"("p_name" "text", "p_as_curated" boolean) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."ensure_project_contribution"("p_project_id" "uuid", "p_user_id" "uuid", "p_display_name" "text", "p_category" "text", "p_subcategory" "text", "p_role_label" "text", "p_source_key" "text", "p_project_title" "text", "p_username" "text") TO "anon";
...
GRANT ALL ON FUNCTION "public"."evidence_has_url"("p_evidence" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."evidence_note_body"("p_evidence" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."evidence_note_body"("p_evidence" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."evidence_note_body"("p_evidence" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."flag_abuse"("p_reason" "text", "p_action" "text", "p_meta" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."flag_abuse"("p_reason" "text", "p_action" "text", "p_meta" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."flag_abuse"("p_reason" "text", "p_action" "text", "p_meta" "jsonb") TO "service_role";



GRANT ALL ON FUNCTION "public"."flag_profile_signup_burst"() TO "anon";
GRANT ALL ON FUNCTION "public"."flag_profile_signup_burst"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."flag_profile_signup_burst"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_ai_studio_spend_micros"("p_period" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_ai_studio_spend_micros"("p_period" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_ai_studio_spend_micros"("p_period" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_contributor_trust"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_contributor_trust"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_contributor_trust"("p_user_id" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_my_ai_token_balance"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_my_ai_token_balance"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_my_ai_token_balance"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_my_ai_token_balance"() TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_my_ai_token_ledger"("p_limit" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_my_ai_token_ledger"("p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_my_ai_token_ledger"("p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_my_ai_token_ledger"("p_limit" integer) TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_my_ai_token_purchases"("p_limit" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_my_ai_token_purchases"("p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_my_ai_token_purchases"("p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_my_ai_token_purchases"("p_limit" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_my_billing_history"("limit_n" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_my_billing_history"("limit_n" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_my_billing_history"("limit_n" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_my_claim_quota"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_my_claim_quota"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_my_claim_quota"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_my_subscription_plan"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_my_subscription_plan"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_my_subscription_plan"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_my_subscriptions"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_my_subscriptions"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_my_subscriptions"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_project_donation_credits"("p_project_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_public_community_stats"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_public_profile_support"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_public_recent_donations"("limit_n" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_public_recent_donations"("limit_n" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_public_recent_donations"("limit_n" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_public_support_summary"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."idea_cast_vote"("p_idea_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."idea_cast_vote"("p_idea_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."idea_cast_vote"("p_idea_id" bigint) TO "service_role";



GRANT ALL ON FUNCTION "public"."idea_tag_is_publicly_selectable"("p_status" "text", "p_usage" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."idea_tag_is_publicly_selectable"("p_status" "text", "p_usage" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."idea_tag_is_publicly_selectable"("p_status" "text", "p_usage" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."ideas_enforce_parent_one_level"() TO "anon";
GRANT ALL ON FUNCTION "public"."ideas_enforce_parent_one_level"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."ideas_enforce_parent_one_level"() TO "service_role";



GRANT ALL ON FUNCTION "public"."is_idea_tag_admin"() TO "anon";
GRANT ALL ON FUNCTION "public"."is_idea_tag_admin"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_idea_tag_admin"() TO "service_role";



GRANT ALL ON FUNCTION "public"."is_idea_tag_staff"() TO "anon";
GRANT ALL ON FUNCTION "public"."is_idea_tag_staff"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_idea_tag_staff"() TO "service_role";
...
GRANT SELECT,REFERENCES,DELETE,TRIGGER,TRUNCATE,MAINTAIN,UPDATE ON TABLE "public"."ideas" TO "anon";
...
GRANT ALL ON FUNCTION "public"."list_idea_children"("p_parent_id" bigint) TO "service_role";



GRANT ALL ON TABLE "public"."task_restriction_events" TO "anon";
GRANT ALL ON TABLE "public"."task_restriction_events" TO "authenticated";
GRANT ALL ON TABLE "public"."task_restriction_events" TO "service_role";



GRANT ALL ON FUNCTION "public"."list_recent_restriction_events"("p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."list_recent_restriction_events"("p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."list_recent_restriction_events"("p_limit" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."normalize_idea_tag_name"("raw" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."normalize_idea_tag_name"("raw" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."normalize_idea_tag_name"("raw" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."normalize_idea_tag_slug"("raw" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."normalize_idea_tag_slug"("raw" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."normalize_idea_tag_slug"("raw" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."normalize_idea_title"("p_title" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."normalize_idea_title"("p_title" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."normalize_idea_title"("p_title" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."public_count_display"("p_true" integer, "p_salt" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."public_count_display"("p_true" integer, "p_salt" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."public_count_display"("p_true" integer, "p_salt" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."recompute_idea_tag_usage"() TO "anon";
GRANT ALL ON FUNCTION "public"."recompute_idea_tag_usage"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."recompute_idea_tag_usage"() TO "service_role";



GRANT ALL ON FUNCTION "public"."refresh_community_showcase_likes_count"() TO "anon";
GRANT ALL ON FUNCTION "public"."refresh_community_showcase_likes_count"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."refresh_community_showcase_likes_count"() TO "service_role";



GRANT ALL ON FUNCTION "public"."refresh_founders_thought_likes_count"() TO "anon";
GRANT ALL ON FUNCTION "public"."refresh_founders_thought_likes_count"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."refresh_founders_thought_likes_count"() TO "service_role";



GRANT ALL ON FUNCTION "public"."refresh_idea_vote_count"() TO "anon";
GRANT ALL ON FUNCTION "public"."refresh_idea_vote_count"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."refresh_idea_vote_count"() TO "service_role";



GRANT ALL ON FUNCTION "public"."reject_task_as_fake_work"("p_task_id" "uuid", "p_feedback" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."reject_task_as_fake_work"("p_task_id" "uuid", "p_feedback" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."reject_task_as_fake_work"("p_task_id" "uuid", "p_feedback" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."request_join_claim"("p_task_id" "uuid", "p_message" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."request_join_claim"("p_task_id" "uuid", "p_message" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."request_join_claim"("p_task_id" "uuid", "p_message" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."request_task_scope_help"("p_task_id" "uuid", "p_note" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."request_task_scope_help"("p_task_id" "uuid", "p_note" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."request_task_scope_help"("p_task_id" "uuid", "p_note" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."resolve_join_request"("p_request_id" "uuid", "p_approve" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."resolve_join_request"("p_request_id" "uuid", "p_approve" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."resolve_join_request"("p_request_id" "uuid", "p_approve" boolean) TO "service_role";



GRANT ALL ON FUNCTION "public"."resolve_task_scope_request"("p_request_id" "uuid", "p_resolution" "text", "p_staff_note" "text") TO "anon";
...
GRANT ALL ON FUNCTION "public"."resolve_task_scope_request"("p_request_id" "uuid", "p_resolution" "text", "p_staff_note" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."return_stale_claims"("p_days" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."return_task_claim"("p_task_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."return_task_claim"("p_task_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."return_task_claim"("p_task_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."review_task_submission"("p_task_id" "uuid", "p_accept" boolean, "p_feedback" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."review_task_submission"("p_task_id" "uuid", "p_accept" boolean, "p_feedback" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."review_task_submission"("p_task_id" "uuid", "p_accept" boolean, "p_feedback" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."run_claim_auto_release"("p_idle_days" integer, "p_max_claim_days" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."run_claim_auto_release_test"() TO "anon";
GRANT ALL ON FUNCTION "public"."run_claim_auto_release_test"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."run_claim_auto_release_test"() TO "service_role";



GRANT ALL ON FUNCTION "public"."set_idea_tags_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_idea_tags_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_idea_tags_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."set_my_pinned_badge"("p_badge_key" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."set_my_pinned_badge"("p_badge_key" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_my_pinned_badge"("p_badge_key" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."set_task_dependencies"("p_task_id" "uuid", "p_blocker_ids" "uuid"[], "p_override" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."set_task_dependencies"("p_task_id" "uuid", "p_blocker_ids" "uuid"[], "p_override" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_task_dependencies"("p_task_id" "uuid", "p_blocker_ids" "uuid"[], "p_override" boolean) TO "service_role";



GRANT ALL ON FUNCTION "public"."submit_task_for_review"("p_task_id" "uuid", "p_evidence" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."submit_task_for_review"("p_task_id" "uuid", "p_evidence" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."submit_task_for_review"("p_task_id" "uuid", "p_evidence" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."sync_idea_tags_after_save"("p_tag_names" "text"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."sync_idea_tags_after_save"("p_tag_names" "text"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_idea_tags_after_save"("p_tag_names" "text"[]) TO "service_role";



GRANT ALL ON FUNCTION "public"."sync_my_badges"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_my_badges"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_my_badges"() TO "service_role";



GRANT ALL ON FUNCTION "public"."sync_parent_claim_progress"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_parent_claim_progress"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_parent_claim_progress"() TO "service_role";



GRANT ALL ON FUNCTION "public"."sync_parent_ready_for_review"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_parent_ready_for_review"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_parent_ready_for_review"() TO "service_role";



REVOKE ALL ON FUNCTION "public"."sync_user_badges"("p_user_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."sync_user_badges"("p_user_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."task_child_progress_percent"("p_task_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."task_dependencies_validate"() TO "anon";
GRANT ALL ON FUNCTION "public"."task_dependencies_validate"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."task_dependencies_validate"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."task_incomplete_blockers"("p_task_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."task_is_dependency_locked"("p_task_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."task_nesting_depth"("p_task_id" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."toggle_idea_vote"("p_idea_id" bigint) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."toggle_idea_vote"("p_idea_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."toggle_idea_vote"("p_idea_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."toggle_idea_vote"("p_idea_id" bigint) TO "service_role";



REVOKE ALL ON FUNCTION "public"."toggle_showcase_like"("p_post_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."toggle_showcase_like"("p_post_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."toggle_showcase_like"("p_post_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."toggle_showcase_like"("p_post_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."touch_bug_reports_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."touch_bug_reports_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."touch_bug_reports_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."touch_community_showcase_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."touch_community_showcase_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."touch_community_showcase_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."touch_official_videos_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."touch_official_videos_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."touch_official_videos_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."touch_platform_suggestions_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."touch_platform_suggestions_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."touch_platform_suggestions_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."trg_sync_badges_on_claim"() TO "anon";
GRANT ALL ON FUNCTION "public"."trg_sync_badges_on_claim"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trg_sync_badges_on_claim"() TO "service_role";



GRANT ALL ON FUNCTION "public"."trg_sync_badges_on_donation"() TO "anon";
GRANT ALL ON FUNCTION "public"."trg_sync_badges_on_donation"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trg_sync_badges_on_donation"() TO "service_role";



GRANT ALL ON FUNCTION "public"."trg_sync_badges_on_subscription"() TO "anon";
GRANT ALL ON FUNCTION "public"."trg_sync_badges_on_subscription"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trg_sync_badges_on_subscription"() TO "service_role";



GRANT ALL ON FUNCTION "public"."trg_task_claim_memorial_credit"() TO "anon";
GRANT ALL ON FUNCTION "public"."trg_task_claim_memorial_credit"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trg_task_claim_memorial_credit"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."try_debit_ai_tokens"("p_user_id" "uuid", "p_tokens" integer, "p_action_key" "text", "p_prompt_summary" "text", "p_provider" "text", "p_model" "text", "p_api_cost_usd_micros" bigint, "p_margin_usd_micros" bigint, "p_idempotency_key" "text", "p_meta" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."try_debit_ai_tokens"("p_user_id" "uuid", "p_tokens" integer, "p_action_key" "text", "p_prompt_summary" "text", "p_provider" "text", "p_model" "text", "p_api_cost_usd_micros" bigint, "p_margin_usd_micros" bigint, "p_idempotency_key" "text", "p_meta" "jsonb") TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."update_task_progress"("p_task_id" "uuid", "p_progress_percent" integer, "p_subtasks" "jsonb", "p_notes" "text", "p_helpers" "jsonb") TO "anon";
...
GRANT ALL ON FUNCTION "public"."update_task_progress"("p_task_id" "uuid", "p_progress_percent" integer, "p_subtasks" "jsonb", "p_notes" "text", "p_helpers" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."user_accepted_task_count"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."user_bypasses_abuse_limits"() TO "anon";
GRANT ALL ON FUNCTION "public"."user_bypasses_abuse_limits"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."user_bypasses_abuse_limits"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."user_bypasses_task_limits"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."user_claim_limit"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."user_completed_claim_count"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."user_completed_task_count"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."user_completed_task_count"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."user_completed_task_count"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."user_donation_total_cents"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."user_donation_total_cents"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."user_donation_total_cents"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."user_identity_gate_status"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."user_is_claim_restricted"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."user_meets_identity_gate"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."user_submit_limit_24h"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."action_rate_events" TO "anon";
GRANT ALL ON TABLE "public"."action_rate_events" TO "authenticated";
...
GRANT ALL ON TABLE "public"."ai_platform_config" TO "anon";
GRANT ALL ON TABLE "public"."ai_platform_config" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_platform_config" TO "service_role";



GRANT ALL ON TABLE "public"."ai_token_ledger_user" TO "anon";
GRANT ALL ON TABLE "public"."ai_token_ledger_user" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_token_ledger_user" TO "service_role";



GRANT ALL ON TABLE "public"."ai_token_purchases" TO "anon";
GRANT ALL ON TABLE "public"."ai_token_purchases" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_token_purchases" TO "service_role";
...
GRANT ALL ON TABLE "public"."claim_join_requests" TO "anon";
...
GRANT ALL ON TABLE "public"."community_showcase_likes" TO "anon";
GRANT ALL ON TABLE "public"."community_showcase_likes" TO "authenticated";
GRANT ALL ON TABLE "public"."community_showcase_likes" TO "service_role";



GRANT ALL ON TABLE "public"."community_showcase_posts" TO "anon";
...
GRANT ALL ON TABLE "public"."founders_thought_likes" TO "anon";
GRANT ALL ON TABLE "public"."founders_thought_likes" TO "authenticated";
GRANT ALL ON TABLE "public"."founders_thought_likes" TO "service_role";



GRANT ALL ON SEQUENCE "public"."founders_thought_likes_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."founders_thought_likes_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."founders_thought_likes_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."founders_thoughts" TO "anon";
GRANT ALL ON TABLE "public"."founders_thoughts" TO "authenticated";
GRANT ALL ON TABLE "public"."founders_thoughts" TO "service_role";



GRANT ALL ON SEQUENCE "public"."founders_thoughts_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."founders_thoughts_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."founders_thoughts_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."idea_tags_public" TO "anon";
GRANT ALL ON TABLE "public"."idea_tags_public" TO "authenticated";
GRANT ALL ON TABLE "public"."idea_tags_public" TO "service_role";
...
GRANT ALL ON TABLE "public"."official_videos" TO "anon";
...
GRANT ALL ON TABLE "public"."phase_games" TO "anon";
GRANT ALL ON TABLE "public"."phase_games" TO "authenticated";
GRANT ALL ON TABLE "public"."phase_games" TO "service_role";



GRANT ALL ON TABLE "public"."platform_suggestions" TO "anon";
GRANT ALL ON TABLE "public"."platform_suggestions" TO "authenticated";
GRANT ALL ON TABLE "public"."platform_suggestions" TO "service_role";
...
GRANT ALL ON TABLE "public"."task_scope_requests" TO "anon";
GRANT ALL ON TABLE "public"."task_scope_requests" TO "authenticated";
GRANT ALL ON TABLE "public"."task_scope_requests" TO "service_role";
...
GRANT ALL ON TABLE "public"."user_task_restrictions" TO "anon";
GRANT ALL ON TABLE "public"."user_task_restrictions" TO "authenticated";
GRANT ALL ON TABLE "public"."user_task_restrictions" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."username_history_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."username_history_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."username_history_id_seq" TO "service_role";
