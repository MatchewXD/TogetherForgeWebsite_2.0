...
- README links Vision, WhatThisIsNot, StyleLock, and TetherRules.', '[{"id":"s1","label":"Docs/StyleLock.md exists and is labeled Draft until approved.","done":false},{"id":"s2","label":"Docs/TetherRules.txt exists with starting bands and Open items labeled.","done":false},{"id":"s3","label":"README links Vision, WhatThisIsNot, StyleLock, and TetherRules.","done":false}]'::jsonb),
    ('Tether-P', 'Tether-P Ready lane', 'Staging Ready lane. These cards stay Staff Only and off the public board until Epic 1 is Done in the Unreal repo.

Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[]'::jsonb),
    ('Tether-P.1', 'Tether-P.1 Contributor docs', 'Contributor docs for running Tether and onboarding.

Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[]'::jsonb),
    ('Tether-P.1.1', 'Tether-P.1.1 How to run Tether', 'How to run Tether.
...
Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[{"id":"s1","label":"README how-to-run is written.","done":false},{"id":"s2","label":"Two screenshots live in Docs/images/.","done":false}]'::jsonb),
    ('Tether-P.1.2', 'Tether-P.1.2 First Spark onboarding note', 'First Spark onboarding note.
...
Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[{"id":"s1","label":"Docs/FirstSpark.md covers claim, review, Grant Credit, and conduct@togetherforge.net.","done":false}]'::jsonb),
    ('Tether-P.2', 'Tether-P.2 Art exploration', 'Art exploration for player, tether, and scale.

Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[]'::jsonb),
    ('Tether-P.2.1', 'Tether-P.2.1 Player stand-in silhouettes', 'Player stand-in silhouettes.
...
Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[{"id":"s1","label":"Three thumbnails exist in Docs/art-explorations/player/.","done":false}]'::jsonb),
    ('Tether-P.2.2', 'Tether-P.2.2 Tether visual directions', 'Tether visual directions.
...
Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[{"id":"s1","label":"Three Low vs High stills exist in Docs/art-explorations/tether/.","done":false}]'::jsonb),
    ('Tether-P.2.3', 'Tether-P.2.3 Modular kit scale sheet', 'Modular kit scale sheet.
...
Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[{"id":"s1","label":"Docs/art-explorations/scale-sheet.md exists.","done":false}]'::jsonb),
    ('Tether-P.3', 'Tether-P.3 QA templates', 'QA templates for playtests.

Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[]'::jsonb),
    ('Tether-P.3.1', 'Tether-P.3.1 Dual-control checklist', 'Control checklist for playtests.
...
Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[{"id":"s1","label":"Docs/qa/DualControlChecklist.md exists.","done":false}]'::jsonb),
    ('Tether-P.3.2', 'Tether-P.3.2 Playtest note template', 'Playtest note template.
...
Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[{"id":"s1","label":"Docs/qa/PlaytestNote.md exists.","done":false}]'::jsonb),
    ('Tether-P.4', 'Tether-P.4 Community credit', 'Credit current off-site helpers.

Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[]'::jsonb),
    ('Tether-P.4.1', 'Tether-P.4.1 Credit current off-site helpers', 'Credit current off-site helpers with Grant Credit.
...
Staff note: Promote to public Ready only after Epic 1 is Done in the Unreal repo.', '[{"id":"s1","label":"Current off-site helpers are credited with Grant Credit (no fake tasks).","done":false}]'::jsonb),
