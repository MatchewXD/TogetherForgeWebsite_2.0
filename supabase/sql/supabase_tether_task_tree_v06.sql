...
Blocker: Waiting on Tether-5.1 Latch enemy.', 'Level Design', 'Medium', 'Medium', false, 60, 'Tether-5.1', '[]'::jsonb),
...
Blocker: Waiting on Tether-5.1 Latch enemy.', 'Level Design', 'Medium', 'Medium', false, 10, 'Tether-5.1', '[]'::jsonb),
...
Blocker: Waiting on Tether-5.1 Latch enemy.', 'Level Design', 'Easy', 'Small', false, 10, 'Tether-5.1', '[{"id":"s1","label":"At least five modular graybox pieces exist in Content/Tether/Modular.","done":false}]'::jsonb),
...
Blocker: Parked until Epic 6 is playtested.', 'Code', 'Medium', 'Medium', false, 20, 'Tether-6', '[]'::jsonb),
    ('Tether-9', null, 'Tether-9 Art pipeline', 'Art pipeline. Style lock approval is Staff Only. Art suggestions belong in Open Questions until staff accept StyleLock.md.', 'Art', 'Medium', 'Medium', true, 90, null, '[]'::jsonb),
